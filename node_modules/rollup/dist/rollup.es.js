...
function tryParse(module, Parser$$1, acornOptions) {
    try {
        return Parser$$1.parse(module.code, __assign({}, defaultAcornOptions, acornOptions, { onComment: function (block, text, start, end) {
...
function dynamicImport(Parser$$1) {
...
var injectDynamicImportPlugin = unwrapExports(lib);
...
var acornImportMeta = function(Parser$$1) {
  return class extends Parser$$1 {
...
function writeOutputFile(graph, build, outputFile, outputOptions) {
    var filename = resolve(outputOptions.dir || dirname(outputOptions.file), outputFile.fileName);
...
var Watcher = /** @class */ (function () {
    function Watcher(configs) {
        ...
        this.emitter = new /** @class */ (function (_super) {
            ...
            return class_1;
        }(EventEmitter))(this.close.bind(this));
