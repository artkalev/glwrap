...
<dl class="details">
    ...
    <dd><ul class="dummy"><li>
        <?js= this.linkto(data.inherits, this.htmlsafe(data.inherits), 'inherited-from') ?>
    </li></ul></dd>
    <?js } ?>
    ...
    <?js if (data.mixes && data.mixes.length) { ?>
        ...
        <?js data.mixes.forEach(function(a) { ?>
            <?js= self.linkto(a, a) ?>&nbsp&nbsp&nbsp
        <?js }); ?>
        </dd>
    <?js } ?>
    ...
    <?js if ((self.conf.hideAuthor !== false) && data.author && author.length) {?>
    ...
    <?js if (data.meta && self.outputSourceFiles && (self.conf.smallSourceLink === false) ) {?>
